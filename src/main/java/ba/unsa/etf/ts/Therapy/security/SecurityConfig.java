    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/daily-reports/**", "/stressrelief/**", "/api/meditation-tools/**", "/api/articles/all", "/api/users/all", "/api/sessions/getAllAvailableSessions/", "/api/patients/checkIfPatientHasChosenPsychologist/**", "/api/patients/by-user-id/**").hasAuthority("ROLE_PATIENT")
