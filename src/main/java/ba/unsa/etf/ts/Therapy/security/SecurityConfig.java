    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/articles/all","/api/patients/**").hasAnyAuthority("ROLE_ADMINISTRATOR", "ROLE_PATIENT")
                        ...
                        .requestMatchers("/api/daily-reports/**", "/api/stressrelief/**", "/api/meditation-tools/**", "/api/articles/all",  "/api/sessions/getAllAvailableSessions/", "/api/patients/checkIfPatientHasChosenPsychologist/**","/api/stressrelief/durationtime").hasAuthority("ROLE_PATIENT")
